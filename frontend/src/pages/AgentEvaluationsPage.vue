...
function failure(caught:unknown):void{
  const labels:Record<number,string>={401:'登录已失效，请重新登录',403:'没有访问权限',404:'记录不存在或不可访问',422:'筛选条件无效'}
